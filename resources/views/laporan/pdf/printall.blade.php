...
@section('content')
    <div class="row">
        <div class="col-sm-12">
            <div>
                <table class="table table-bordered table-responsive" id="tbprintall">
                    <thead>
                        <tr>
                            <td>No.</td>
                            <td>No. Nota</td>
                    ...
                    <tbody>
                        @foreach($detils as $key=>$d)
                            <tr>
                                <td><p>{{$key+1}}</p></td>
                                <td><p>{{$d->penjualan->no_nota}}</p></td>
                                <td><p>{{$d->penjualan->tgl_jual}}</p></td>
                                <td><p>{{$d->penjualan->user->name}}</p></td>
