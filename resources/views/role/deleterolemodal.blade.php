    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-tittle"> Hapus Role</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" enctype="multipart/form-data" role="form" id="frmdeleterole" action="{{url('/deleterole')}}" method="POST">
                    {!! csrf_field() !!}

                    <div class="form-group">
                        <label for="user_name" class="col-sm-2 control-label">Role</label>
                        <div class="col-sm-8">
                            <input type="text" id="role_name" name="role_name" class="form-control" readonly>
                    ...
                    <div class="form-group">
                        <div class="col-sm-1 col-sm-offset-2"><button type="submit" class="btn btn-danger"><i class="fa fa-btn fa-trash"></i> Hapus</button></div>
                    </div>
                </form>
            </div>
        </div>
