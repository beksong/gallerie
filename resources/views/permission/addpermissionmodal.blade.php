    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-tittle"> Create New Permission</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" enctype="multipart/form-data" role="form" id="frmaddpermission" action="{{url('/createpermission')}}" method="POST">
                    {!! csrf_field() !!}

                    <div class="form-group">
                        <label for="user_name" class="col-sm-2 control-label">Permission</label>
                        <div class="col-sm-8">
