<div class="modal fade" id="editbarangmodal" tabindex="-1" role="dialog" aria-labelledby="mymodallabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-tittle"> Ubah Data Barang</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" enctype="multipart/form-data" role="form" id="frmeditbarang" action="{{url('/updatebarang')}}" method="POST">
                    {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control required" type="text" id="hrg_beli" name="hrg_beli" onblur="hrgbeli()" placeholder="Rp. 0,-" oninvalid="this.setCustomValidity('Harga Beli/Modal Barang Tidak Boleh Kosong')" autocomplete="off" required/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control required" type="text" id="hrg_jual" name="hrg_jual" onblur="hrgjual()" placeholder="Rp. 0,-" oninvalid="this.setCustomValidity('Harga Jual Barang Tidak Boleh Kosong')" autocomplete="off" required/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control required" type="number" id="stok" min="0" name="stok" placeholder="Stok Barang" oninvalid="this.setCustomValidity('Stok Barang Tidak Boleh Kosong')" required/>
                        </div>
                        @if ($errors->has('stok'))
                            <span class="help-block">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="number" id="stok_min" min="0" name="stok_min" placeholder="Stok Minimum Barang"/>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input class="form-control" type="number" id="discount" min="0" name="discount" placeholder="Discount Penjualan"/>
                        </div>
